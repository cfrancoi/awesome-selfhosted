...
- [ZincSearch](https://zincsearch-docs.zinc.dev/) - Search engine that requires minimal resources (alternative to Elasticsearch). [Source Code](https://github.com/zincsearch/zincsearch)) `Apache-2.0` `Go/Docker/K8S`
